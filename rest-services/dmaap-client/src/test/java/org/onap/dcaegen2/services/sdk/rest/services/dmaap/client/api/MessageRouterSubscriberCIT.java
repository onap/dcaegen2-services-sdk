...
class MessageRouterSubscriberCIT {
    ...
    private static String getDockerComposeFilePath(){
        String resourceName = "dmaap-msg-router/message-router-compose.yml";
        try {
            return MessageRouterSubscriberCIT.class.getClassLoader()
                    .getResource(resourceName).getFile();
        }catch (NullPointerException e){
            throw new DockerComposeNotFoundException(String
