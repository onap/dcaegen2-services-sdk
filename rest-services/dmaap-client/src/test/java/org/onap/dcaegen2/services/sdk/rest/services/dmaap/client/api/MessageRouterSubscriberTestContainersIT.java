...
@Disabled("Disabled until find out how to start DMaap with sample topic")
@org.testcontainers.junit.jupiter.Testcontainers
class MessageRouterSubscriberTestContainersIT {
    private static final Duration TIMEOUT = Duration.ofSeconds(10);
    private static final int DMAAP_SERVICE_EXPOSED_PORT = 3904;
    private static final Flux<JsonPrimitive> messageBatch = Flux.just("I", "like", "pizza")
    ...
    static void setUp(){
        ...
        mrRequest =  createMRPublishRequest("TOPIC","text/plain");
    }


    @BeforeEach
    void beforeEach(){
        publisher.put(mrRequest, messageBatch).blockLast();
    }
    ...
    void subscriber_shouldHandleNoSuchTopicException(){
        ...
        final MessageRouterSubscribeRequest mrRequest = createMRSubscribeRequest(topic);
        final String expectedFailReason = String.format(
                "404 Not Found\n{\"mrstatus\":3001,\"helpURL\":\"http://onap.readthedocs.io\",\"message\":\"No such topic exists.-[%s]\",\"status\":404}",
                topic);
    ...
    void subscriber_shouldGetCorrectResponse(){
        ...
        final JsonArray expectedItems = new JsonArray();
        expectedItems.add("I");
        ...
        //when
        Mono<MessageRouterSubscribeResponse> response = sut.get(mrRequest);
    ...
    private static MessageRouterPublishRequest createMRPublishRequest(String topic, String contentType){
