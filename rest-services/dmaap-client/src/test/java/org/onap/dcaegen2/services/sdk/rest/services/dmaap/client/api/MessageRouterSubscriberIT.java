...
class MessageRouterSubscriberIT {
    ...
    static void setUp() {
        ...
        mrFailingRequest = createFailingRequest();
    }
    ...
    void subscriber_shouldGetUnauthorizedErrorResponse(){
        ImmutableMessageRouterSubscribeRequest request = ImmutableMessageRouterSubscribeRequest
                .builder()
                .sourceDefinition(sourceDefinition)
                .consumerGroup(CONSUMER_GROUP)
                .consumerId(FAILING_WITH_401_CONSUMER_ID)
                .build();
        ...
        ImmutableMessageRouterSubscribeResponse expectedResponse = ImmutableMessageRouterSubscribeResponse
                .builder()
                .failReason(String.format("401 Unauthorized\n%s", ERROR_MESSAGE))
                .build();
    ...
    void subscriber_shouldGetForbiddenErrorResponse(){
        ImmutableMessageRouterSubscribeRequest request = ImmutableMessageRouterSubscribeRequest
                ...
                .sourceDefinition(sourceDefinition)
                .consumerGroup(CONSUMER_GROUP)
                .consumerId(FAILING_WITH_403_CONSUMER_ID)
                .build();
        ...
        ImmutableMessageRouterSubscribeResponse expectedResponse = ImmutableMessageRouterSubscribeResponse
                .builder()
                .failReason(String.format("403 Forbidden\n%s", ERROR_MESSAGE))
                .build();
    ...
    void subscriber_shouldGetConflictErrorResponse(){
        ImmutableMessageRouterSubscribeRequest request = ImmutableMessageRouterSubscribeRequest
                ...
                .sourceDefinition(sourceDefinition)
                .consumerGroup(CONSUMER_GROUP)
                .consumerId(FAILING_WITH_409_CONSUMER_ID)
                .build();
        ...
        ImmutableMessageRouterSubscribeResponse expectedResponse = ImmutableMessageRouterSubscribeResponse
                .builder()
                .failReason(String.format("409 Conflict\n%s", ERROR_MESSAGE))
                .build();
    ...
    void subscriber_shouldGetTooManyRequestsErrorResponse(){
        ImmutableMessageRouterSubscribeRequest request = ImmutableMessageRouterSubscribeRequest
                ...
                .sourceDefinition(sourceDefinition)
                .consumerGroup(CONSUMER_GROUP)
                .consumerId(FAILING_WITH_429_CONSUMER_ID)
                .build();
        ...
        ImmutableMessageRouterSubscribeResponse expectedResponse = ImmutableMessageRouterSubscribeResponse
                .builder()
                .failReason(String.format("429 Too Many Requests\n%s", ERROR_MESSAGE))
                .build();
    ...
    void subscriber_shouldGetInternalServerErrorResponse(){
        ...
        ImmutableMessageRouterSubscribeResponse expectedResponse = ImmutableMessageRouterSubscribeResponse
                .builder()
                .failReason(String.format("500 Internal Server Error\n%s", ERROR_MESSAGE))
                .build();
    ...
    private static MessageRouterSubscribeRequest createFailingRequest(){
        return ImmutableMessageRouterSubscribeRequest
                .builder()
                .sourceDefinition(sourceDefinition)
                .consumerGroup(CONSUMER_GROUP)
                .consumerId(FAILING_WITH_500_CONSUMER_ID)
                .build();
    }
}
