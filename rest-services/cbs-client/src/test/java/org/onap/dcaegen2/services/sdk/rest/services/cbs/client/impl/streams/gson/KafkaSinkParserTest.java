...
class KafkaSinkParserTest {
    ...
    void shouldParseMinimalKafkaSinkDefinition() throws IOException {
        // given
        RawDataStream<JsonObject> input = DataStreamUtils.readDataSinkFromResource("/streams/kafka_sink_minimal.json");
    ...
    void shouldParseFullKafkaSinkDefinition() throws IOException {
        // given
        RawDataStream<JsonObject> input = DataStreamUtils.readDataSinkFromResource("/streams/kafka_sink.json");
    ...
    void shouldReturnErrorWhenStructureIsWrong() throws IOException {
        // given
        RawDataStream<JsonObject> input = DataStreamUtils.readDataSinkFromResource("/streams/kafka_sink_missing_child.json");
    ...
    void shouldReturnErrorWhenTypeIsWrong() throws IOException {
        // given
        RawDataStream<JsonObject> input = DataStreamUtils.readDataSinkFromResource("/streams/kafka_invalid_type.json");
    ...
    void shouldReturnErrorWhenDirectionIsWrong() throws IOException {
        // given
        RawDataStream<JsonObject> input = DataStreamUtils.readDataSourceFromResource("/streams/kafka_sink.json");
