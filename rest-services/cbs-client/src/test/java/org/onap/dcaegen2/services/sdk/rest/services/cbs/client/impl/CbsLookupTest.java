...
class CbsLookupTest {
    ...
    private void givenConsulResponse(JsonArray jsonArray) {
        given(httpClient.call(any(HttpRequest.class), any(ResponseTransformer.class)))
    ...
    private void verifyHttpGetHasBeenCalled(String url) {
        ...
        verify(httpClient).call(httpRequestArgumentCaptor.capture(), isA(ResponseTransformer.class));
