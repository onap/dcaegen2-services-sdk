...
class KafkaSourceParserTest {
    ...
    void shouldParseMinimalKafkaSourceDefinition() throws IOException {
        // given
        RawDataStream<JsonObject> input = DataStreamUtils.readDataSourceFromResource("/streams/kafka_source_minimal.json");
    ...
    void shouldParseFullKafkaSourceDefinition() throws IOException {
        // given
        RawDataStream<JsonObject> input = DataStreamUtils.readDataSourceFromResource("/streams/kafka_source.json");
    ...
    void shouldReturnErrorWhenTypeIsWrong() throws IOException {
        // given
        RawDataStream<JsonObject> input = DataStreamUtils.readDataSourceFromResource("/streams/kafka_invalid_type.json");
    ...
    void shouldReturnErrorWhenDirectionIsWrong() throws IOException {
        // given
        RawDataStream<JsonObject> input = DataStreamUtils.readDataSinkFromResource("/streams/kafka_source.json");
