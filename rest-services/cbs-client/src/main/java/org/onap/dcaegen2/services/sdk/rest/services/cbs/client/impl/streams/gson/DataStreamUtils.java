...
public final class DataStreamUtils {
    ...
    static RawDataStream<JsonObject> readSourceFromResource(String resource) throws IOException {
        return rawDataStream(resource, DataStreamDirection.SOURCE, GsonUtils.readObjectFromResource(resource));
    }

    static RawDataStream<JsonObject> readSinkFromResource(String resource) throws IOException {
