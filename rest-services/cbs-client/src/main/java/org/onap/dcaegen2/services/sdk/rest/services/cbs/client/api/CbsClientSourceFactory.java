...
public class CbsClientSourceFactory {
    private static final Logger LOGGER = LoggerFactory.getLogger(CbsClientSourceFactory.class);

    public static @NotNull CbsClientSource createCbsClientSource(RxHttpClient httpClient,
                                                                 String serviceName,
        ...
        try {
            ...
            return new CbsClientConfigMap(jsonObjectSupplier);
        } catch(Exception ex) {
            ...
            return new CbsClientRest(httpClient, serviceName, cbsAddress, protocol);
        }
    }
}
