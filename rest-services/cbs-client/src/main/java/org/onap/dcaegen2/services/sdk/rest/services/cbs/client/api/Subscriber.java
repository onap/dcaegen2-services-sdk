...
/**
 * DCAE apps configuration representation (subscribers side).   
 *
...
public interface Subscriber {
    ...
    /**
     * A type of Subscriber, each type has its specific fields to set
     *
     * @return configured Subscriber type
     * @since 1.1.2
     */
    @NotNull
