...
class MerkleTreeParser {
     ...
     * Label created this way is appended to element's path in the tree. </p>
     ...
     * For each JsonArray element artificial path is created separately as described
     * in {@link MerkleTreeParser#ARTIFICIAL_NODE_PREFIX}.</p>
     *
    ...
    private HashMap<List<String>, String> handleArray(List<String> newPrefix, JsonArray jsonArray) {
        ...
        for (JsonElement jsonElement : jsonArray) {
            String jsonKey = ARTIFICIAL_NODE_PREFIX + labelIndex++;
