 ...
 */
@Value.Immutable
public interface DataRouterCredentials {

    /**
     * Username the publisher uses to authenticate to Data Router
     *
     * @return configured Data Router username
     * @since 1.1.2
     */
    @NotNull
    String username();
     ...
     *
     * @return configured Data Router password
     * @since 1.1.2
     */
    @NotNull
    String password();
    ...
    default void validate() {
        if (username() == null || password() == null) {
            throw new IllegalArgumentException("Username and password should be defined");
        }
    }
}
