...
public class CbsClientImpl implements CbsClient {
    ...
    @Override
    public @NotNull Mono<JsonObject> get(DiagnosticContext diagnosticContext) {
        return Mono.defer(() -> httpClient.callHttpGet(fetchUrl, diagnosticContext, JsonObject.class));
    }
}
