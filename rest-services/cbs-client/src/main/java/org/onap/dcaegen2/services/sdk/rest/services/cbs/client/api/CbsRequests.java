...
public final class CbsRequests {
     ...
     *
     * <p>Will bind the configuration for given environment and return the bound configuration.</p>
     *
     ...
     *
     * @param diagnosticContext logging diagnostic context (MDC)
     * @param serviceName name of the service for which the request is to be performed
     * @return the CbsRequest ready to be used when calling {@link CbsClient}
     */
    public static @NotNull CbsRequest getConfiguration(RequestDiagnosticContext diagnosticContext, String serviceName) {
        return ImmutableCbsRequest.builder()
                ...
                .requestPath("/service_component/" + serviceName)
                .build();
    }
     ...
     *
     * <p>Will bind the configuration for given environment and return the bound configuration, policies, and any other
    ...
    public static @NotNull CbsRequest getAll(RequestDiagnosticContext diagnosticContext, String serviceName) {
        return ImmutableCbsRequest.builder()
                .diagnosticContext(diagnosticContext)
                .requestPath("/service_component_all/" + serviceName)
                .build();
    }
