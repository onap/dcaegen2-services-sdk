...
public interface CbsClientConfiguration {
    ...
    /**
     * Name of variable containing Config Binding Service secure network port.
     */
    Integer ENV_CBS_PORT_SECURE = 10443;
    ...
    static CbsClientConfiguration fromEnvironment() {
        ...
        if (pathToCaCert == null || pathToCaCert.equals("")) {
            ...
            return configBuilder
                    .trustStoreKeys(crateSecurityKeysFromEnvironment(createPathToJksFile(getEnv(DCAE_CA_CERT_PATH))))
