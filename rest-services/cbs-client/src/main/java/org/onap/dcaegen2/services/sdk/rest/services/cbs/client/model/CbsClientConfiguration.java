...
public interface CbsClientConfiguration {
    ...
    */
    ...
    static CbsClientConfiguration fromEnvironment() {
        ...
        String pathToCerts = pathToCaCertPemFile.substring(0,pathToCaCertPemFile.lastIndexOf("/"));
        ...
        return !Files.exists(Paths.get(pathToCerts + "/"))
                ? configuration.withPort(Integer.valueOf(System.getenv(ENV_CBS_PORT)))
                : configuration
                    .withSecurityKeys(crateSecurityKeysFromEnvironment(pathToCerts))
