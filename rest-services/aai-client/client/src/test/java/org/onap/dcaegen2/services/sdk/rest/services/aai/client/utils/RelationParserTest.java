...
public class RelationParserTest {
    ...
    public static class FindRelatedToTest {
        ...
        @Test
        public void findRelationOnEmptyRelationListShouldReturnEmptyStream() {
            ...
            //when
            final Stream<Relationship> maybeRel1 = findRelatedTo(emptyRelations, RELATED_TYPE, UNKNOWN);
            final Stream<Relationship> maybeRel2 = findRelatedTo(emptyRelations, OTHER_TYPE, UNKNOWN);
        ...
        public void findRelationWithNonContainedTypeShouldReturnEmptyOptional() {
            ...
            //when
            final Stream<Relationship> maybeRel = findRelatedTo(SINGLE_RELATIONSHIP, OTHER_TYPE, UNKNOWN);
        ...
        public void findRelationWithContainedTypeShouldReturnDefinedOptional() {
            ...
            //when
            final Stream<Relationship> maybeRel1 = findRelatedTo(SINGLE_RELATIONSHIP, RELATED_TYPE, UNKNOWN);
            final Stream<Relationship> maybeRel2 = findRelatedTo(MULTIPLE_RELATIONSHIP, RELATED_TYPE, UNKNOWN);
            final Stream<Relationship> maybeRel3 = findRelatedTo(MULTIPLE_RELATIONSHIP, OTHER_TYPE, UNKNOWN);
