...
import org.onap.dcaegen2.services.sdk.rest.services.aai.common.exceptions.AaiAlreadyExistsException;
    ...
    private static AaiException toAaiException(final HttpResponse response) {
        switch (response.statusCode()) {
            ...
            case AaiBadArgumentException.ERROR_CODE:
                return new AaiBadArgumentException();
            case AaiAlreadyExistsException.ERROR_CODE:
                return new AaiAlreadyExistsException();
            default:
                return new AaiServiceConnectionException(response.statusCode());
        }
    }
