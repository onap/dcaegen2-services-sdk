...
class AaiRequestsBuilder {
    ...
    private final static Map<String, String> JSON_CONTENT = of("Content-Type", "application/json");
    private final static Map<String, String> ACCEPT_JSON = of("Content-Type", "application/json");
    private final static Map<String, String> PATCH_CONTENT = of("Content-Type", "application/merge-patch+json");
