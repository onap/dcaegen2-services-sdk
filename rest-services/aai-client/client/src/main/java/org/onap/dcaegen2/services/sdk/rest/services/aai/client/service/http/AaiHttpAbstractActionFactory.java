...
public abstract class AaiHttpAbstractActionFactory extends AaiActionFactoryBase {
    ...
    public AaiHttpAbstractActionFactory(AaiClientConfiguration configuration) {
        this(configuration, RxHttpClientFactory::createInsecure, RxHttpClientFactory::create);
    }

    public AaiHttpAbstractActionFactory(
    ...
    protected Map<String, String> getHeaders() {
        final Option<String> aaiUser = Option.of(configuration.aaiUserName()).filter(String::isEmpty);
        final Option<String> aaiPassword = Option.of(configuration.aaiUserName()).filter(String::isEmpty);
...
//                .map(encoded -> headers.put(BASIC_AUTH_HEADER, "Basic QUFJOkFBSQ=="))
//                .getOrElse(headers);
    }
}