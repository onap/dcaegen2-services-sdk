...
abstract class AaiHttpAbstractActionFactory extends AaiActionFactoryBase {
    ...
    protected final AaiClientConfiguration configuration;

    protected AaiHttpAbstractActionFactory(final AaiClientConfiguration configuration) {
    ...
    protected SecurityKeys createSslKeys() {
    ...
    protected <T extends AaiModel> Function<T, String> getQueryUrlMapping(Class<T> type) {
        return Option
    ...
    protected <T extends AaiModel> String getUrl(Class<T> type, T model) {
        return getQueryUrlMapping(type)
                .andThen(this::buildUri)
                .apply(model);
    }
