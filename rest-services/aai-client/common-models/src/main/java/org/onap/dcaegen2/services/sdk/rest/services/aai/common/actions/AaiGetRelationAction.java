...
public interface AaiGetRelationAction<T extends AaiRelationable, U extends AaiModel>
        extends AaiAction<T, AaiRelation<T, U>> {

    <S extends T> Mono<AaiRelation<S, U>> callT(S model);

    @Override
    default Mono<AaiRelation<T, U>> call(T model) {
        return this.callT(model);
    }
}
