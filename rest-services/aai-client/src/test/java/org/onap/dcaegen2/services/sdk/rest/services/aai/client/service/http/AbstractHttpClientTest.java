...
public class AbstractHttpClientTest {
    ...
    protected CloudHttpClient httpClient = mock(CloudHttpClient.class);
    protected JsonBodyBuilder bodyBuilder = mock(JsonBodyBuilder.class);
    protected HttpResponse response = mock(HttpResponse.class);
