...
public interface HvVesProducer {
     ...
     *
     * Each invocation of this method will yield a new TCP connection. It is recommended call this method only once and
     * feed it with a stream of consecutive events.
     *
