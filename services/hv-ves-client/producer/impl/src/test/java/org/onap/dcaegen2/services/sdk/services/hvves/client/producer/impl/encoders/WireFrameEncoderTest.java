...
import static org.onap.dcaegen2.services.sdk.services.hvves.client.producer.impl.encoders.PayloadType.PROTOBUF;
...
public class WireFrameEncoderTest {
    ...
    void encode_givenNullPayload_shouldThrowEncodingException() {
        ...
        assertThrows(WTPEncodingException.class, () -> wireFrameEncoder.encode(buffer));
    }
    ...
    void encode_givenSomePayloadBytes_shouldCreateValidGPBFrameWithPayloadAtTheEnd() {
        ...
        assertNextBytesAreInOrder(encodedBuffer, PROTOBUF.getPayloadTypeBytes());
