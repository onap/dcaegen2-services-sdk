...
class SchemaReferenceResolverTest {
    ...
    void shouldResolveUrlFromSchemaReference() {
        ...
        //when
        String actualUrl = SchemaReferenceResolver.resolveUrl(schemaReference);
    ...
    void shouldResolveUrlFromSchemaReferenceWhenInternalReferenceDoesNotExist() {
        ...
        //when
        String actualUrl = SchemaReferenceResolver.resolveUrl(expectedUrl);
    ...
    void shouldResolveInternalReferenceFromSchemaReference() {
        ...
        //when
        String actualInternalReference = SchemaReferenceResolver.resolveInternalReference(schemaReference);
