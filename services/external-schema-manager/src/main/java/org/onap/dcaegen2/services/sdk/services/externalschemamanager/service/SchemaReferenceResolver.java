...
public class SchemaReferenceResolver {
    ...
    private SchemaReferenceResolver() {}

    public static String resolveUrl(String schemaReference) {
        String[] referenceFragments = schemaReference.split(SchemaReference.URL_SEPARATOR);
        return referenceFragments[URL_INDEX];
    }

    public static String resolveInternalReference(String schemaReference) {
        String reference;
        String[] referenceFragments = schemaReference.split(SchemaReference.URL_SEPARATOR);
    ...
    private static String prepareExistingInternalReference(String internalReference) {
        String reference;
    ...
    private static boolean isAbsolute(String internalReference) {
        return internalReference.startsWith(ROOT_REFERENCE);
    }

    private static boolean internalReferenceExists(String[] referenceFragments) {
