...
class SchemaReferenceMapper {
    ...
    String mapToLocalSchema(String publicSchemaReference) {
        String publicUrl = urlSplitter.getUrlPart(publicSchemaReference);
        String localUrl = urlMapper.mapToLocalUrl(publicUrl);
        return createLocalSchemaReference(localUrl, urlSplitter.getFragmentPart(publicSchemaReference));
    }

    private String createLocalSchemaReference(String localUrl, String urlFragment) {
