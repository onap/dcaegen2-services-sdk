...
import org.onap.dcaegen2.services.sdk.services.externalschemamanager.service.JsonSplitter;
import org.onap.dcaegen2.services.sdk.services.externalschemamanager.service.SchemaReferenceJsonGenerator;
import org.onap.dcaegen2.services.sdk.services.externalschemamanager.service.SchemaReferenceMapper;
import org.onap.dcaegen2.services.sdk.services.externalschemamanager.service.UrlMapper;
import org.onap.dcaegen2.services.sdk.services.externalschemamanager.service.UrlSplitter;
...
public class Validator {
    ...
    //todo fix log when internal reference is incorrect, when file is not found it throws exc as well
    //todo move cache to new class
    //todo check why validator doesn't cache
    ...
    private synchronized SchemaValidator getValidatorFromCache(String publicSchemaReference) throws IOException {
    ...
    private SchemaValidator createValidator(String localSchemaReference) throws IOException {
        ...
        SchemaValidator schemaValidator = getValidator(schemaNode);
        cacheSchemaValidator(localSchemaReference, schemaValidator);
        return schemaValidator;
    }

    private SchemaValidator getValidator(JsonNode schemaNode) {
        try {
