...
public class Validator {
    ...
    private SchemaValidator getValidatorFromCache(String publicSchemaReference) throws IOException {
    ...
    private SchemaValidator getValidator(JsonNode schemaNode) {
        try {
            ...
            throw new IncorrectFileInternalReference("Schema reference refer to existing file, " +
