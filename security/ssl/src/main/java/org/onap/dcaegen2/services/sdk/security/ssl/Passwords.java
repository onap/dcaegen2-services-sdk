...
public final class Passwords {
     ...
     *
     * <em>WARNING</em>: Avoid using this method. It will be impossible to clear memory containing the password. It
     * can be cleared by garbage collector in some time in the future.
     *
     *
